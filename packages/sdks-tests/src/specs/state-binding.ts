...
export const CONTENT = {
    ...
    blocks: [
      {
        ...
        id: 'khulnasoft-acd0aa86d9ca4fac908b223b28874025',
        meta: {
          bindingActions: {
            component: {
              options: {
      ...
      },
      {
        ...
        id: 'khulnasoft-a5e821841dbb4b1aa5ca297adf1bb2eb',
        meta: {
          eventActions: {
            click: [
              {
      ...
      },
      {
        ...
        id: 'khulnasoft-23e218ab8c334ca4a710e5dd02115ddd',
        meta: {
          eventActions: {
            click: [
              {
      ...
      {
        id: 'khulnasoft-pixel-rwn1w8oltb',
        '@type': '@khulnasoft.com/sdk:Element',
        tagName: 'img',
        properties: {
          src: 'https://cdn.khulnasoft.com/api/v1/pixel?apiKey=47e08601f65f4dc8b2d34f109dcce4f0',
          'aria-hidden': 'true',
          alt: '',
          role: 'presentation',
          width: '0',
  ...
  meta: {
    kind: 'page',
    lastPreviewUrl:
      'http://localhost:5173/47e08601f65f4dc8b2d34f109dcce4f0/qwik-sdk-events/?khulnasoft.space=47e08601f65f4dc8b2d34f109dcce4f0&khulnasoft.cachebust=true&khulnasoft.preview=page&khulnasoft.noCache=true&__khulnasoft_editing__=true&khulnasoft.overrides.page=bc00782838e048a9b9e8e840a4a4d0c2&khulnasoft.overrides.bc00782838e048a9b9e8e840a4a4d0c2=bc00782838e048a9b9e8e840a4a4d0c2&khulnasoft.overrides.page:/47e08601f65f4dc8b2d34f109dcce4f0/qwik-sdk-events/=bc00782838e048a9b9e8e840a4a4d0c2',
    hasLinks: false,
  },
  variations: {},
