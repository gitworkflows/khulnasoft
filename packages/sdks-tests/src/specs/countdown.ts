    ...
    blocks: [
      {
        ...
        '@version': 2,
        id: 'khulnasoft-78174ff2f0ce49b58bc65819f10bcea4',
        meta: {
          previousId: 'khulnasoft-41d78e7bf5f145029f9711ff45f7f2af',
        },
        component: {
          name: 'Symbol',
          options: {
            symbol: {
              ...
              content: {
                ...
                data: {
                  cssCode:
                    '.khulnasoft-heading-1{font-size:2em;margin:.67em 0}.khulnasoft-heading-2{font-size:1.5em;margin:.75em 0}.khulnasoft-heading-3{font-size:1.17em;margin:.83em 0}.khulnasoft-heading-4,.khulnasoft-paragraph{margin:1.12em 0}.khulnasoft-heading-5{font-size:.83em;margin:1.5em 0}.khulnasoft-heading-6{font-size:.75em;margin:1.67em 0}.khulnasoft-heading-1,.khulnasoft-heading-2,.khulnasoft-heading-3,.khulnasoft-heading-4,.khulnasoft-heading-5,.khulnasoft-heading-6{font-weight:bolder}',
                  inputs: [
                    {
                  ...
                  blocks: [
                    {
                      ...
                      id: 'khulnasoft-fae1d95cc43744b2be2bf0f0d266ed87',
                      component: {
                        name: 'Columns',
                        options: {
                          columns: [
                              ...
                              blocks: [
                                {
                                  '@type': '@khulnasoft.com/sdk:Element',
                                  '@version': 2,
                                  id: 'khulnasoft-9291b10a59ea45d1a08e0aa1cc1313fc',
                                  children: [
                                    {
                                      '@type': '@khulnasoft.com/sdk:Element',
                                      '@version': 2,
                                      ...
                                      layerName: 'Days',
                                      id: 'khulnasoft-96072992ddad46c59a3e7aa1ae8cfede',
                                      properties: {
                                        id: 'days',
                                      },
                                      component: {
                                    ...
                                    },
                                    {
                                      ...
                                      '@version': 2,
                                      layerName: 'Days text',
                                      id: 'khulnasoft-bc689d5841e14421b71c83a57b807645',
                                      component: {
                                        name: 'Text',
                                        options: {
                                          text: '<p>Days</p>',
                              ...
                              blocks: [
                                {
                                  '@type': '@khulnasoft.com/sdk:Element',
                                  '@version': 2,
                                  id: 'khulnasoft-2334a79e203648ec8d6e810f8bf75f66',
                                  children: [
                                    {
                                      '@type': '@khulnasoft.com/sdk:Element',
                                      '@version': 2,
                                      ...
                                      layerName: 'Hours',
                                      id: 'khulnasoft-e7d86cede2174afd9ef1473446e94200',
                                      properties: {
                                        id: 'hours',
                                      },
                                      component: {
                                    ...
                                    },
                                    {
                                      ...
                                      id: 'khulnasoft-196a55a59b8d4a72b991c235df098c11',
                                      component: {
                                        name: 'Text',
                                        options: {
                                          text: '<p>Hours</p>',
                              ...
                              blocks: [
                                {
                                  '@type': '@khulnasoft.com/sdk:Element',
                                  '@version': 2,
                                  id: 'khulnasoft-3e9355850dce4cee8425bf01b8617702',
                                  children: [
                                    {
                                      '@type': '@khulnasoft.com/sdk:Element',
                                      '@version': 2,
                                      ...
                                      layerName: 'Minutes',
                                      id: 'khulnasoft-402b3377b7464b45946678f6eec35cc5',
                                      properties: {
                                        id: 'minutes',
                                      },
                                      component: {
                                    ...
                                    },
                                    {
                                      ...
                                      id: 'khulnasoft-6d899c8f7cf748759ab7cab878f57e4e',
                                      component: {
                                        name: 'Text',
                                        options: {
                                          text: '<p>Minutes</p>',
                              ...
                              blocks: [
                                {
                                  '@type': '@khulnasoft.com/sdk:Element',
                                  '@version': 2,
                                  id: 'khulnasoft-8bfc4f0f99dc4239acf69c181af2f9d7',
                                  children: [
                                    {
                                      '@type': '@khulnasoft.com/sdk:Element',
                                      '@version': 2,
                                      ...
                                      layerName: 'Seconds',
                                      id: 'khulnasoft-74c509cbd53a452cb18c0c21dae9fddb',
                                      properties: {
                                        id: 'seconds',
                                      },
                                      component: {
                                    ...
                                    },
                                    {
                                      ...
                                      id: 'khulnasoft-39d338ca716a4d86a695d9f45c96c0eb',
                                      component: {
                                        name: 'Text',
                                        options: {
                                          text: '<p>Seconds</p>',
