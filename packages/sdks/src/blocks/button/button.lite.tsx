import { useMetadata, useStore, useTarget } from '@khulnasoft.com/mitosis';
  ...
  const state = useStore({
    attrs() {
      return {
        ...
        [getClassPropName()]: `${props.link ? '' : 'khulnasoft-button'} ${
      ...
      TagName={useTarget({
        reactNative: props.link
          ? // eslint-disable-next-line @typescript-eslint/ban-ts-comment
            // @ts-ignore
            props.khulnasoftLinkComponent || BaseText
          : // eslint-disable-next-line @typescript-eslint/ban-ts-comment
            // @ts-ignore
            BaseText,
        default: props.link ? props.khulnasoftLinkComponent || 'a' : 'button',
      })}
