import { registerCommercePlugin } from '@khulnasoft.com/commerce-plugin-tools';
import { Resource } from '@khulnasoft.com/commerce-plugin-tools/dist/types/interfaces/resource';
...
const pluginId = '@khulnasoft.com/plugin-shopify-demo';
      ...
      if (confirm) {
        ...
        try {
          ...
          appState.dialogs.alert(
            'If this problem persists, please contact support@khulnasoft.com',
