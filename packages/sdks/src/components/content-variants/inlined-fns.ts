 ...
 * see our [SSR A/B Test Docs](https://github.com/khulnasoft-com/khulnasoft/tree/main/packages/sdks/src/SSR_AB_TEST.md)
 */
function updateCookiesAndStyles(
  ...
  function getAndSetVariantId(): string {
    ...
    const cookieName = `khulnasoft.tests.${contentId}`;
...
/**
 * For more information on how this works,
 * see our [SSR A/B Test Docs](https://github.com/khulnasoft-com/khulnasoft/tree/main/packages/sdks/docs/SSR_AB_TEST.md)
 */
function updateVariantVisibility(
  ...
  const cookieName = `khulnasoft.tests.${defaultContentId}`;
