...
export default function Accordion(props: AccordionProps) {
  const state = useStore({
    ...
    getAccordionTitleClassName(index: number) {
      return `khulnasoft-accordion-title khulnasoft-accordion-title-${
        state.open.includes(index) ? 'open' : 'closed'
      }`;
    },
    getAccordionDetailClassName(index: number) {
      return `khulnasoft-accordion-detail khulnasoft-accordion-detail-${
        state.open.includes(index) ? 'open' : 'closed'
      }`;
    },
  ...
  return (
    <div class="khulnasoft-accordion" style={state.accordionStyles}>
