...
const HELLO_CUSTOM_COMPONENT_LOADED_MESSAGE =
  'KHULNASOFT_EVENT: khulnasoft.registerComponent Component name: Hello';
const LAST_COMPONENT_REGISTERED_MESSAGE =
  'KHULNASOFT_EVENT: khulnasoft.registerComponent Component name: KhulnasoftBlockWithClassName';
