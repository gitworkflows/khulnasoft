...
import { KhulnasoftComponent, Khulnasoft } from '@khulnasoft.com/react/lite';
import { makeStyles } from '@material-ui/core/styles';
import './index.css';
import './khulnasoft-settings';
  ...
  return (
    <div>
      ...
      <div className={classes.container}>
        {!notFound ? (
          // For server side rendering see here: https://github.com/khulnasoft-com/khulnasoft/tree/master/packages/react/examples/next-js
          <KhulnasoftComponent
            model="page"
            contentLoaded={content => {
              if (!content && !Khulnasoft.isEditing) {
                setNotFound(true);
              }
            }}
          >
    ...
    <div className={classes.notFound}>
      ...
      {process.env.NODE_ENV === 'development' && (
        <h4 className={classes.notFoundSubTitle}>
          To edit this page in Khulnasoft.com, go to{' '}
          <a target="_blank" href="https://khulnasoft.com">
            khulnasoft.com
          </a>
