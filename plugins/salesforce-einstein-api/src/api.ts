...
import { Resource } from '@khulnasoft.com/commerce-plugin-tools';
...
const transformRecommender = (rec: Recommender) => ({
  ...
  title: rec.name,
  image: {
    src: 'https://cdn.khulnasoft.com/api/v1/image/assets%2Fd1ed12c3338144da8dd6b63b35d14c30%2Fe1439f0d991c4e2d968c84a38059f1d2',
  },
});

export const getRecommenders = (siteId: string, clientId: string): Promise<Array<Resource>> => {
  const url = new URL('https://cdn.khulnasoft.com/api/v1/proxy-api');
