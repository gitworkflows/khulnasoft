import { registerDataPlugin } from '@khulnasoft.com/data-plugin-tools';
import pkg from '../package.json';
import { createDeliveryClient } from '@kentico/kontent-delivery';
import { Input } from '@khulnasoft.com/sdk';

// development URL https://localhost:1268/plugin.system.js?pluginId=@khulnasoft.com/plugin-kontent-ai
...
registerDataPlugin(
  {
    id: pluginId,
    name: 'Kontent.ai',
    icon: 'https://cdn.khulnasoft.com/api/v1/image/assets%2F0b9554e4c74747a08f247f55227230e0%2F4830cd357f5f480983ae6e0caf817076',
    settings: [
      {
        name: 'projectId',
        type: 'string',
