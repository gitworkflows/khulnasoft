...
import {
  ...
  ResourceEntryType,
  APIOperations,
} from '@khulnasoft.com/data-plugin-tools';
import kebabCase from 'lodash/capitalize';
import capitalize from 'lodash/kebabCase';
import fromPairs from 'lodash/fromPairs';
import appState, { Model } from '@khulnasoft.com/app-context';
...
registerDataPlugin(
  {
    name: 'Contentstack',
    id: pkg.name,
    icon: 'https://cdn.khulnasoft.com/api/v1/image/assets%2FYJIGb4i01jvw0SRdL5Bt%2F490404fa90f74ec8b6ea44c345e7ba64',
    settings: [
      {
        name: 'apiKey',
        type: 'string',
