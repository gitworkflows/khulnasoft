...
export function bindAnimations(animations: KhulnasoftAnimation[]) {
...
function augmentAnimation(animation: KhulnasoftAnimation, element: HTMLElement) {
...
function getAllStylesUsed(animation: KhulnasoftAnimation) {
...
export function triggerAnimation(animation: KhulnasoftAnimation) {
...
export function bindScrollInViewAnimation(animation: KhulnasoftAnimation) {
