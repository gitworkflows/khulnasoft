...
const libraryName = 'khulnasoft-webcomponents';
  ...
  plugins: [
    ...
    alias({
      entries: {
        ...
        '@khulnasoft.com/react': path.resolve(
          './node_modules/@khulnasoft.com/react/dist/khulnasoft-react.es5.js'
        ),
        '@khulnasoft.com/sdk': path.resolve('./node_modules/@khulnasoft.com/sdk/dist/index.esm.js'),
        ...(REACT
          ? {
...
export default [
  ...
  // {
  //   ...options,
  //   output: [{ file: pkg.unpkg, format: 'iife', sourcemap: true, name: 'KhulnasoftWC' }],
  ...
  //       sourcemap: true,
  //       amd: {
  //         id: '@khulnasoft.com/webcomponents'
  //       }
  //     }
  //   ],
  //   plugins: options.plugins.concat([uglify(), sourceMaps()])
