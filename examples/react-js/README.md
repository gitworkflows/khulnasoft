...
This example walks you through using Khulnasoft.com with a minimal React application.
...
1. Change into the example application by using the `cd` command:
   ...
   ```shell
   cd khulnasoft/examples/react-js
   ```
...
In the [Account settings](https://khulnasoft.com/account/space), copy your Public API Key. We're going to paste the API Key into `YOUR_API_KEY` in `src/main.jsx`.
...
[![Deploy with Vercel](https://vercel.com/button)](https://vercel.com/new/git/external?repository-url=https%3A%2F%2Fgithub.com%2Fkhulnasoftio%2Fkhulnasoft%2Ftree%2Fmain%2Fexamples%2Freact-js)
