...
import { KhulnasoftRequest } from './interfaces/khulnasoft-request';
...
export type ResourceType = {
  ...
  toUrl: (options: Record<string, any>) => string | KhulnasoftRequest | Promise<string> | Promise<KhulnasoftRequest>;
...
export interface DataPluginOptions {
  id: string; // match npm package name @khulnasoft.com/plugin-shopify,
...
export const registerDataPlugin = async (
  ...
  Khulnasoft.register('plugin', { ...config, isDataPlugin: true });
