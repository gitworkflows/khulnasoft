...
export const registerCommercePlugin = async (
  ...
  const registerEditors = async () => {
    ...
    resources.forEach(resourceName => {
      ...
      Khulnasoft.register('editor.onLoad', onEditorLoad(config, apiOperations, resourceName));
  ...
  Khulnasoft.register('plugin', { ...config, isSourcePlugin: true });
...
export { KhulnasoftRequest } from './interfaces/khulnasoft-request';
export {
  ResourcePreviewCell,
  ResourcePickerProps,
