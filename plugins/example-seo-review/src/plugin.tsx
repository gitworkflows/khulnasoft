...
/**
 * Instruct khulnasoft to require few settings before running the plugin code, for example when an apiKey for the service is required
 */
registerPlugin(
  {
    name: 'SEOReview',
    ...
    // Khulnasoft will notify plugin user to configure the settings above, and call this function when it's filled
  ...
  async settings => {
    ...
    registerContentAction({
      ...
      async onClick(content) {
        ...
        // example for saving the result of seo review in a khulnasoft data model, for easier retrieval
