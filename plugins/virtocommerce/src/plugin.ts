import { CommerceAPIOperations, registerCommercePlugin } from '@khulnasoft.com/commerce-plugin-tools';
...
registerCommercePlugin(
  ...
  settings => {
    ...
    const baseUrl = (url: string) => {
      ...
      return `https://cdn.khulnasoft.com/api/v1/proxy-api?url=${encodeURIComponent(endUrl)}`;
      // return endUrl;
    };
    ...
    const service: CommerceAPIOperations = {
      product: {
        ...
        // https://github.com/khulnasoft-com/khulnasoft/blob/master/plugins/shopify/src/interfaces/khulnasoft-request.ts
