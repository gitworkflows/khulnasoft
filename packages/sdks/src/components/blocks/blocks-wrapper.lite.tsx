...
export type BlocksWrapperProps = {
  blocks: KhulnasoftBlock[] | undefined;
...
export default function BlocksWrapper(props: BlocksWrapperProps) {
    ...
    useTarget({
      reactNative: () => {
        if (isEditing()) {
           ...
           */
          if (state.dataPath) {
            blocksWrapperRef.setAttribute('khulnasoft-path', state.dataPath);
          }
          if (props.parent) {
            blocksWrapperRef.setAttribute('khulnasoft-parent-id', props.parent);
          }
        }
      },
      default: () => {},
  ...
  return (
    <props.BlocksWrapper
      ...
      khulnasoft-path={state.dataPath}
      khulnasoft-parent-id={props.parent}
      {...useTarget({
        reactNative: { dataSet: { class: state.className } },
        default: {},
      })}
      style={props.styleProp}
      // eslint-disable-next-line @khulnasoft.com/mitosis/css-no-vars
      css={useTarget({
