...
import {
  ...
  getInheritedStyles,
  getRepeatItemData,
  provideKhulnasoftBlock,
  provideKhulnasoftContext,
...
export default function Block(props: BlockProps) {
  const state = useStore({
     ...
     */
    _processedBlock: { value: null as KhulnasoftBlock | null, update: false },
    get processedBlock(): KhulnasoftBlock {
      useTarget({
        svelte: () => {},
        vue: () => {},
        angular: () => {},
    ...
    get componentRefProps(): ComponentProps {
      return {
        ...
        componentOptions: {
          ...
          ...provideKhulnasoftBlock(state.blockComponent, state.processedBlock),
          ...provideKhulnasoftContext(state.blockComponent, props.context),
        ...
        registeredComponents: props.registeredComponents,
        khulnasoftBlock: state.processedBlock,
    ...
    useTarget({
      ...
      angular: () => {
        ...
        if (animations && blockId) {
          // in Angular, the DynamicDiv sets attributes (khulnasoft-id) on the element late (ngAfterViewInit)
        ...
        when={!state.blockComponent?.noWrap}
          ...
          >
            <ComponentRef
              ...
              khulnasoftBlock={state.componentRefProps.khulnasoftBlock}
