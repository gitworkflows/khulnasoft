...
export const HOST = 'http://khulnasoft.com';
export const openKhulnasoft = async (projectName: string, starter: Starter, port: number = 3000) => {
...
export const openKhulnasoftAuth = async (port: number, clientId: string) => {
