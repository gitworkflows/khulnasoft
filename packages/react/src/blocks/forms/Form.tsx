...
import { KhulnasoftElement, Khulnasoft, khulnasoft } from '@khulnasoft.com/sdk';
...
class FormComponent extends React.Component<FormProps> {
  ...
  get submissionState() {
    return (Khulnasoft.isEditing && this.props.previewState) || this.state.state;
  }
          ...
          >
            ...
            >
              ...
              {this.submissionState === 'error' && (
                <KhulnasoftBlocks dataPath="errorMessage" blocks={this.props.errorMessage!} />
              )}

              {this.submissionState === 'sending' && (
                <KhulnasoftBlocks dataPath="sendingMessage" blocks={this.props.sendingMessage!} />
              )}
              ...
              {this.submissionState === 'error' && this.state.responseData && (
                // TODO: tag to edit
                <pre
                  className="khulnasoft-form-error-text"
              ...
              {this.submissionState === 'success' && (
                <KhulnasoftBlocks dataPath="successMessage" blocks={this.props.successMessage!} />
              )}
            </form>
          </KhulnasoftStoreContext.Provider>
        )}
...
export const Form = withKhulnasoft(FormComponent, {
  name: 'Form:Form',
  // editableTags: ['khulnasoft-form-error']
  defaults: {
    responsiveStyles: {
      large: {
        marginTop: '15px',
  ...
  image:
    'https://cdn.khulnasoft.com/api/v1/image/assets%2FIsxPKMo2gPRRKeakUztj1D6uqed2%2Fef36d2a846134910b64b88e6d18c5ca5',
  inputs: [
    {
      name: 'sendSubmissionsTo',
      type: 'string',
      // TODO: save to khulnasoft data and user can download as csv
