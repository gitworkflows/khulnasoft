...
import { getKhulnasoftSearchParamsFromWindow } from '../get-khulnasoft-search-params/index.js';
...
export const generateContentUrl = (options: GetContentOptions): URL => {
  ...
  const baseUrl = apiHost || 'https://cdn.khulnasoft.com';
  ...
  const queryOptions = {
    ...getKhulnasoftSearchParamsFromWindow(),
...
const getUserAttributesAsJSON = (queryOptions: any) => {
  if (isBrowser() && queryOptions['preview'] === 'KHULNASOFT_STUDIO') {
