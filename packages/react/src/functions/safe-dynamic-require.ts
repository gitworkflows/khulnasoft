 ...
 *
 * That broke in case Khulnasoft was running on the server (Next, SSR use-cases) where
 * globalThis.require was undefined. Avoiding use of Khulnasoft.isServer for Cloudflare worker cases
...
if (
  ...
  (Khulnasoft.isServer && typeof require === 'function')
) {
  try {
    /*
    ...
    */
    ...
    /* 
      ...
      Relevant issue : https://github.com/khulnasoft-com/khulnasoft-shopify-hydrogen/issues/12
    */
