import { KhulnasoftElement } from '@khulnasoft.com/react';

const getRandomAspectTile = (): KhulnasoftElement => ({
  ...defaultTile,
  component: {
...
const defaultTile: KhulnasoftElement = {
  ...
  component: {
    ...
    options: {
      image:
        'https://khulnasoft.com/api/v1/image/assets%2Fpwgjf0RoYWbdnJSbpBAjXNRMe9F2%2Ffb27a7c790324294af8be1c35fe30f4d?width=2000&height=1200',
...
export const masonryConfig: any = {
  name: 'Khulnasoft:Masonry',
  // TODO: default children
  image:
    'https://cdn.khulnasoft.com/api/v1/image/assets%2FBvYIl5jKN9QpChUB3PVzsTe2ZSI2%2F7ed6bd8129d148608ecec09300786d71?width=2000&height=1200',
