import { KhulnasoftContent, Input, KhulnasoftElement, Component } from '@khulnasoft.com/sdk';
import React from 'react';
type Content = KhulnasoftContent | ContentModel;

/**
 * Content model is a wrapped content JSON object with some
 * additional methods and a few other differences
 */
interface ContentModel extends KhulnasoftContent {
  ...
  /**
   * A flattened list, good for doing operations on all layers in a khulnasoft
   * page or content
   *
   * @example
...
export interface ApplicationContext {
  createContent(modelName: string, data: Partial<KhulnasoftContent>): Promise<KhulnasoftContent>;
  user: {
    id: string;
  ...
  khulnasoftComponents: Component[];
  contentEditorPage: {
