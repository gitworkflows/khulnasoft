export const HOVER_ANIMATION = {
  ...
  meta: {
    hasLinks: false,
    lastPreviewUrl:
      'http://localhost:3001/kadak?khulnasoft.space=ad30f9a246614faaa6a03374f83554c9&khulnasoft.cachebust=true&khulnasoft.preview=page&khulnasoft.noCache=true&khulnasoft.allowTextEdit=true&__khulnasoft_editing__=true&khulnasoft.overrides.page=acb83ec528444ca3b6fd0c74fed2e347&khulnasoft.overrides.acb83ec528444ca3b6fd0c74fed2e347=acb83ec528444ca3b6fd0c74fed2e347&khulnasoft.overrides.page:/kadak=acb83ec528444ca3b6fd0c74fed2e347&khulnasoft.options.locale=Default',
    kind: 'page',
  },
  priority: -416,
  query: [
    ...
    blocks: [
      {
        ...
        '@version': 2,
        id: 'khulnasoft-6479a1b0df5e43f9badb0b084ec15dcd',
        animations: [
          {
            trigger: 'hover',
            animation: 'custom',
