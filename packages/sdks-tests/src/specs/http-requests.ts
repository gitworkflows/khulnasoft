export const HTTP_REQUESTS = {
  ...
  data: {
    ...
    blocks: [
      {
        ...
        id: 'khulnasoft-ae1475bc1a1941ce839d210f20b96192',
        component: {
          name: 'Text',
    ...
    httpRequests: {
      article:
        'https://cdn.khulnasoft.com/api/v1/proxy-api?url=https%3A%2F%2Fcdn.contentstack.io%2Fv3%2Fcontent_types%2Farticle%2Fentries%3Fenvironment%3Dprod&headers.api_key=bltc12136c3b9f23503&headers.access_token=cs4291c43a722a771559bd3b3d',
    },
    state: {
      deviceSize: 'large',
  ...
  screenshot:
    'https://cdn.khulnasoft.com/api/v1/image/assets%2Ff1a790f8c3204b3b8c5c1795aeac4660%2F34622bca1dd941968b25341a40be51f7',
