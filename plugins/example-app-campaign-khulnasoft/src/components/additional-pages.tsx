...
export function AdditionalPages(props: CustomEditorProps<string[]>) {
  ...
  const state = useLocalStore(() => ({
    entry: null as null | KhulnasoftContent,
    loadingEntry: false,
    async getEntry() {
...
function ContentPreviewCell(props: {
  ...
  return useObserver(() => {
    ...
    const contentCache = props.context.httpCache.get(
      ...
      `https://cdn.khulnasoft.com/api/v3/content/_any/${props.contentId}?apiKey=${props.context.user.apiKey}&fields=name,id,screenshot,published`,
