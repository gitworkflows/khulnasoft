...
export const AssetSelector: React.FC<KhulnasoftPluginProps<BynderAssetFile>> = props => {
  const addProps = {
    ...props,
    ...
    // Hopefully Khulnasoft will provide a way to select these via the plugin interface,
...
const RenderSinglePreview: React.FC<RenderSinglePreviewProps> = ({
  ...
  // Khulnasoft provided context for matching the editor theme
