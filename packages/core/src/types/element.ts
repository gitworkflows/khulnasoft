...
/**
 * An object representing an element in Khulnasoft
 */
export interface KhulnasoftElement {
  ...
  code?: {
     ...
     * written in Khulnasoft's Data view. The values can be literal or dynamic expressions,
