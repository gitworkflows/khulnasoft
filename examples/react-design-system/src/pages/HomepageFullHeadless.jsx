...
// Use this as reference for using Khulnasoft data models w/ React.
...
const HeroContainer = styled.a`
  ...
  background-image: ${props =>
    ...
    (props.backgroundImage ||
      'https://cdn.khulnasoft.com/api/v1/image/assets%2FbqNZC3dTGjwbxXySE419%2F0fb37235a9c94992b4400cbfbe884778?width=2000') +
    ')'};
  cursor: pointer;
  pointer-events: auto;
  flex-grow: 0;
  ...
  @media (max-width: 991px) {
    ...
    display: flex;
    padding-bottom: 60px;
    background-image: url(https://cdn.khulnasoft.com/api/v1/image/assets%2FbqNZC3dTGjwbxXySE419%2Fc4dd6e27c2be41eea5aec91f1a35b862?width=998);
    flex-grow: 0;
  }
  @media (max-width: 640px) {
    ...
    padding-top: 36px;
    padding-left: 0px;
    background-image: url(https://cdn.khulnasoft.com/api/v1/image/assets%2FbqNZC3dTGjwbxXySE419%2F50e11d77c80944949801093f23254ceb?width=638);
    flex-grow: 0;
    padding-bottom: 80px;
  }
`;
...
const SecondaryBannerContainer = styled.div`
  ...
  background-image: ${props =>
    'url(' +
    (props.backgroundImage ||
      'https://cdn.khulnasoft.com/api/v1/image/assets%2Ffdbd25dbc32e4eb7a62b2e2389bb946b%2Fa400e9af9c2646ae9ef0a68784e74479') +
    ');'};
  background-repeat: no-repeat;
  background-position: center;
  background-size: cover;
...
const Div15 = styled.div`
  ...
  margin-top: 15px;
  height: 25vh;
  background-image: url(https://cdn.khulnasoft.codes/api/v1/image/assets%2Fpwgjf0RoYWbdnJSbpBAjXNRMe9F2%2F535b441b503945e5aaf8dddecf05c274?width=1000&height=1000);
  background-repeat: no-repeat;
  background-position: center;
  background-size: cover;
`;
...
const Div20 = styled.div`
  ...
  margin-top: 15px;
  height: 25vh;
  background-image: url(https://cdn.khulnasoft.codes/api/v1/image/assets%2Fpwgjf0RoYWbdnJSbpBAjXNRMe9F2%2Fb6ca4e08d9494ceebcdbcfc737199986?width=1000&height=1000);
  background-repeat: no-repeat;
  background-position: center;
  background-size: cover;
`;
...
const Div25 = styled.div`
  ...
  margin-top: 15px;
  height: 25vh;
  background-image: url(https://cdn.khulnasoft.codes/api/v1/image/assets%2Fpwgjf0RoYWbdnJSbpBAjXNRMe9F2%2Fc80a211bc0c24edd83ba91f481cf57eb?width=1000&height=1000);
  background-repeat: no-repeat;
  background-position: center;
  background-size: cover;
`;
...
export function HomepageFullHeadless() {
  return (
    <>
      <KhulnasoftContent modelName="homepage-headless-content">
        {(data, loading) => (
          <div>
            <HeroContainer
            ...
            <div>
              {data?.isCategoryRowShown ? (
                <Div12>
                  <Div13 className="khulnasoft-columns">
                    <Div14 className="khulnasoft-column">
                      <Div15>
                        <Div16>
                          <Div17>
                            <p>jeans</p>
                    ...
                    <Div19 className="khulnasoft-column">
                      <Div20>
                        <Div21>
                          <Div22>
                            <p>sweaters</p>
                    ...
                    <Div24 className="khulnasoft-column">
                      <Div25>
                        <Div26>
                          <Div27>
                            <p>hats</p>
