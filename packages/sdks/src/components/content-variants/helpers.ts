 ...
 */
const UPDATE_COOKIES_AND_STYLES_SCRIPT_NAME = 'khulnasoftIoAbTest';
const UPDATE_VARIANT_VISIBILITY_SCRIPT_FN_NAME = 'khulnasoftIoRenderContent';

export const getVariants = (content: Nullable<KhulnasoftContent>) =>
